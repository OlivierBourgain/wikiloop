...
public class LinkParserTest {
    ...
    public void ignoreItalicText() throws Exception {
        ...
        Assert.assertEquals(Long.valueOf(3L), fixture.getFirstLink("Page 0", text));
    }
    ...
    public void test1() {
        ...
        Assert.assertEquals(Long.valueOf(10L), fixture.getFirstLink("Page 0 ", text));
    ...
    public void uncapitaliseLink() {
        ...
        Assert.assertEquals(Long.valueOf(4L), fixture.getFirstLink("Page 0 ", text));
    ...
    public void testPersonneMorale() {
        ...
        Assert.assertEquals(Long.valueOf(12L), fixture.getFirstLink("Page 0 ", text));
    ...
    public void testPierreAntoineMotteux() {
        ...
        Assert.assertEquals(Long.valueOf(11L), fixture.getFirstLink("Page 0 ", text));
    }
